  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="twoulaundrytestApp.invoice.delete.question">
          <Translate contentKey="twoulaundrytestApp.invoice.delete.question" interpolate={{ id: invoiceEntity.id }}>
