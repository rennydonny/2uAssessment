    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="twoulaundrytestApp.invoice.home.createOrEditLabel">
              <Translate contentKey="twoulaundrytestApp.invoice.home.createOrEditLabel">Create or edit a Invoice</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : invoiceEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="invoice-total" type="text" name="total" />
                </AvGroup>
                <AvGroup>
                  ...
                  >
                    <option value="USD">{translate('twoulaundrytestApp.Currency.USD')}</option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  ...
                  >
                    <option value="PENDING">{translate('twoulaundrytestApp.InvoiceStatus.PENDING')}</option>
                    <option value="APPROVED">{translate('twoulaundrytestApp.InvoiceStatus.APPROVED')}</option>
                  </AvInput>
                </AvGroup>
