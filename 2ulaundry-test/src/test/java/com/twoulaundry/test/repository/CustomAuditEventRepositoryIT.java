package com.twoulaundry.test.repository;

import com.twoulaundry.test.TwoulaundrytestApp;
import com.twoulaundry.test.config.Constants;
import com.twoulaundry.test.config.audit.AuditEventConverter;
import com.twoulaundry.test.domain.PersistentAuditEvent;
...
import static com.twoulaundry.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
